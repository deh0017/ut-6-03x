...
#define SYSCTL_RCC_XTAL_16MHZ     0x00000540 // bit 10-6  16-MHz Crystal. 10101 = 16 MHz
...
#define SYSCTL_RCC2_DIV400        0x40000000 // bit 30  divide PLL as 400 MHz vs. 200 MHz
#define SYSCTL_RCC2_SYSDIV2       0x1FC00000 // bit 28-23  System Clock Divider
#define SYSCTL_RIS_R              (*((volatile unsigned long *)0x400FE050))
#define SYSCTL_RIS_PLLLRIS        0x00000040 // bit 7. PLL Lock Raw Interrupt Status
